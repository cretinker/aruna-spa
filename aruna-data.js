...
export const T = {
  ...
  es: {
    ...
    heroEyebrow: 'Staten Island · desde 2014 · cuarenta y ocho tratamientos',
    heroH1a: 'Nadie debería poder', heroH1b: 'notar', heroH1c: 'que te lo hiciste.',
    heroSub: 'Cejas, labios, cuero cabelludo, piel y láser en un estudio en casa en Staten Island desde 2014. Todos los precios están en esta página, porque deberías saber el número antes de estar sentada en la silla.',
    heroCall: 'Llama al estudio', heroChips: '¿Qué te hizo mirarte dos veces esta mañana?',
    statSince: 'En la misma calle, en la misma sala, desde',
    ...
    whyEyebrow: 'Cómo se hace el trabajo',
    whyH1a: 'Por eso parece', whyH1b: 'que', whyH1c: 'no pasó nada.',
    whySub: 'Te diremos qué puede y qué no puede hacer un tratamiento en tu piel antes de que pagues. Todo lo de abajo es la razón por la que eso es posible.',
    why1t: 'Noventa minutos', why1b: 'Es lo que tardan unas cejas. Nadie está agendado encima de ti, y nadie apura tu forma para llegar a la siguiente cita.',
    why2t: 'La segunda cita', why2b: 'El pigmento se asienta distinto en cada piel, así que una sola sesión nunca es el resultado final. Tu retoque ya está pagado. Es parte del trabajo, no un extra.',
    why3t: 'Los dos precios', why3b: 'En efectivo baja cada servicio de maquillaje permanente, y ves las dos cifras antes de elegir. Nada se renegocia cuando llegas.',
    scalpEyebrow: 'Micropigmentación capilar',
    scalpH1a: 'Recupera tu línea,', scalpH1b: 'sin cirugía.',
    scalpBody: 'Para densidad en la raya, entradas, alopecia o cobertura de cicatrices. Tres horas, sin cirugía, sin recuperación y sin nada que tomar cada mañana. Financiado en cuatro pagos.',
    scalpMeta: 'y más · 180 minutos', scalpCta: 'Leer sobre el tratamiento',
    dreamEyebrow: 'Noventa minutos de todo',
    dreamH1a: 'El Dream', dreamH1b: 'Facial.',
    dreamBody: 'Limpieza profunda, hydrafacial, dermaplaning y masaje de radiofrecuencia en noventa minutos, y luego los productos Lemieux que usamos en tu cara, en tamaño viaje, para llevar.',
    dreamMeta: '90 minutos', dreamCta: 'Todos los faciales y piel',
    pmuEyebrow: 'Maquillaje permanente',
    pmuH1a: 'Aquí ningún tratamiento', pmuH1b: 'es', pmuH1c: '«precio a consultar».',
    pmuSub: 'Cuánto te dura depende de tu piel, no de la técnica que elijas. Quien te prometa un número fijo de años te está vendiendo algo.',
    pmuAll: 'Los cuarenta y ocho tratamientos',
    bookT: 'Antes de reservar',
    bookB: 'Clientas nuevas de cejas y PMU: $150 por ausencia o cancelación con menos de 24 horas. Cambiar la cita toma cinco segundos y el hueco se lo lleva otra persona.',
    tenEyebrow: 'Diez razones por las que llaman',
    tenH1a: 'Empieza por lo que', tenH1b: 'te', tenH1c: 'molesta.',
    tenSub: 'Cada una abre un presupuesto con precio para ese tratamiento. Sin consulta obligatoria, sin depósito y sin «precio a consultar».',
    ctaEyebrow: 'Seis preguntas, sin depósito',
    ctaH1a: 'Averigua cuánto', ctaH1b: 'cuesta', ctaH1c: 'antes de llamar.',
    ctaSub: 'Seis preguntas, tu precio con tarjeta y en efectivo uno al lado del otro, y luego una hora. No se reserva nada, no se cobra nada, y nadie te llama si no lo pides.',
    ctaBtn: 'Ver mi precio'
  }
};
